    ...
    return (
        <div className='group'>
            <div className='relative group overflow-hidden'>
                ...
                <img alt={` image`} width={400} height={600} className='w-full h-full group-hover:scale-110 transform transition-transform ease-in-out duration-1000 cursor-pointer' src='https://i.postimg.cc/fyGddz6G/oneplus-watch.png' />
            ...
            <div className='text-center p-3'>
                <Link to={`/product/`} className='text-2xl transition-all duration-300 hover:text-orange-500'><h1>kasdlf</h1></Link>
                <div className='flex items-center justify-center gap-3'>
                    <h2 className='text-lg text-[#F85712]'>${578}</h2>
                    <h2 className='text-lg text-gray-400 line-through'>${613}</h2>
                </div>
            </div>
        </div>
    );
